...
export const Logo = () => {
    return (
        <Link to="/" className="flex items-center gap-3 text-white group">
            <div className="flex items-center justify-center size-9 rounded-lg border border-neutral-800 bg-neutral-900 group-hover:border-neutral-700 transition-colors">
                <svg
                    width="18"
                    height="22"
                    viewBox="0 0 20 24"
            ...
            <div className="flex flex-col text-left leading-none">
                <span className="text-[9px] font-mono font-bold tracking-[0.25em] text-brand uppercase">
                    MXDUB
                </span>
